...
2. Since this repo is written in python and uses heavily standard python libaries such as numpy/scipy/opencv, it is recommended to install the Anaconda python enviromnet on Faust.
